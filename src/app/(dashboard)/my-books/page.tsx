  ...
  if (!user && !loading) {
    return (
      <div className="max-w-4xl mx-auto py-16 px-4 text-center">
        ...
        <h2 className="text-xl font-bold text-slate-800">আপনার বইয়ের তালিকা দেখতে লগইন করুন</h2>
        <Link
          href="/login"
          className="inline-block mt-4 px-6 py-2.5 bg-emerald-600 text-white font-bold rounded-xl"
        >
          লগইন করুন
        </Link>
      </div>
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <Link
          href="/list-book"
          className="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-sm text-sm"
        >
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-3xl p-12 border border-slate-200 text-center shadow-xs">
          <Library className="w-12 h-12 text-emerald-300 mx-auto mb-3" />
          <h3 className="text-lg font-bold text-slate-800">আপনার কোনো বই লিস্ট করা নেই</h3>
          <p className="text-sm text-slate-500 max-w-md mx-auto mt-1 mb-6">
            আপনার অব্যবহৃত বা পুরনো বইগুলো আজই পোস্ট করুন এবং অন্য শিক্ষার্থীদের সাহায্য করুন।
          </p>
          <Link
            href="/list-book"
            className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 text-white font-bold rounded-xl shadow-md shadow-emerald-600/20"
          >
            <PlusCircle className="w-4 h-4" />
            প্রথম বই পোস্ট করুন
          </Link>
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mb-2">লেখক: {book.author}</p>
                  <p className="text-[11px] text-emerald-700 font-medium truncate mb-4">
